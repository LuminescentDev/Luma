...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <header id="kc-header" class="pf-v5-c-login__header">
      <div id="kc-header-wrapper" class="pf-v5-c-brand kc-luma-brand">
        <img class="kc-luma-brand-logo" src="${url.resourcesPath}/img/logo.png" alt="" width="40" height="40" aria-hidden="true" />
        <span class="kc-luma-brand-name">Luma</span>
      </div>
    </header>
