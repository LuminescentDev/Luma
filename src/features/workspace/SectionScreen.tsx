...
const CONTENT = {
  ...
  sftp: { title: "SFTP", description: "Browse and transfer files between local and remote systems.", icon: FolderOpen },
} as const;

export function SectionScreen({ section }: { section: Extract<SidebarSection, "logs" | "sftp"> }) {
