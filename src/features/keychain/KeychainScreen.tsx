...
export function KeychainScreen() {
  ...
  <div className={`${editing ? "hidden md:block" : "block"} min-w-0 flex-1 overflow-y-auto`}>
    <div className="px-4 py-4 pt-safe md:border-b md:border-border md:bg-surface md:px-3 md:py-3">
      ...
      <div className="keychain-toolbar mx-auto flex max-w-375 items-center gap-2">
